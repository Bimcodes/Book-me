...
class AppStyles {
  ...
  static Color bigDotBlue = const Color(0xFF8ACCF7);
  static Color planeSecondColor = const Color(0xFFBACCF7);
  static Color containerPink = const Color(0xFFFEF4F3);
  static Color profileBlue = const Color(0xFF526799);
  static Color grey = Colors.grey.shade300;
  static Color grey2 = Colors.grey.shade600;
  static Color grey3 = Colors.grey;
